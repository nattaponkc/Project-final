...
("SELECT p.id, p.product_name, p.product_qty, p.price_hot, p.price_cold, p.price_frappe, p.product_image, 
            ...
            <table id="example1" class="table table-bordered table-striped table-sm">
                <thead>
                  <tr class="table-info">
                    ...
                    <th width="3%" class="text-center">ราคา(ร้อน)</th>
                    <th width="3%" class="text-center">ราคา(เย็น)</th>
                    <th width="3%" class="text-center">ราคา(ปั่น)</th>
                ...
                <?php 
                  ...
                  <tr>
                    ...
                    <td align="right"><?=number_format( $row['price_hot'], 2);?></td>  
                    <td align="right"><?=number_format( $row['price_cold'], 2);?></td>
                    <td align="right"><?=number_format( $row['price_frappe'], 2);?></td>   
