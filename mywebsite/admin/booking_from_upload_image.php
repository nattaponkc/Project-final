                            ...
                            <form action="" method="post" onsubmit="return ValidateTypeFile(this);" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2">ภาพห้องพัก</label>
                                        <div class="col-sm-4">
                            ...
                            <tbody>
                                ...
                                foreach ($rsImg as $row) { ?>
                                    <tr>
                                        ...
                                        <td><img src="../assets/room_gallery/<?= $row['room_image']; ?>" width="100px"></td>
                                        <td>../assets/room_gallery/<?= $row['room_image']; ?></td>
...
if (isset($_POST['room_id']) && isset($_POST['btn']) && $_POST['btn'] == 'upload') {
    ...
    try {
        ...
        for ($i = 0; $i < $total; $i++) {
            ...
            if ($tmpFilePath != "") {
                ...
                //โฟลเดอร์ที่เก็บไฟล์
                $path = "../assets/room_gallery/"; // เปลี่ยนโฟลเดอร์เก็บไฟล์ภาพเป็น room_gallery
...
if (isset($_POST['id']) && isset($_POST['no']) && isset($_POST['room_image']) && isset($_POST['act']) && $_POST['act'] == 'deleteImg') {
    ...
    if ($stmtDelProductImg->rowCount() == 1) {
        ...
        //ลบไฟล์ภาพ
        unlink('../assets/room_gallery/' . $product_image);
        ...
        echo '<script>
             setTimeout(function() {
              swal({
                  ...
                  window.location = "booking.php?id=' . $id . '&act=image"; //หน้าที่ต้องการให้กระโดดไป
              });
            }, 1000);
        </script>';
        exit();
